...
public class SAFFileWriter {
     ...
     *
     * @param activity:    Activity for context and starting request for OPEN_DOCUMENT_TREE
     * @param requestCode: Request code to listen to OPEN_DOCUMENT_TREE
     */
     ...
     *
     * @param parentDirectory : Parent directory where directory with "directoryName" should be created
     * @param displayName     name of subdirectory
     ...
     * @throws ExternalFileWriterException if external storage is not available or free space is less than size of the data
     */
     ...
     * @param data byte array which you want to write a file. If size of this is greater than size available, it will show error.
     */
     ...
     *
     * @param file : File where data is to be written.
     * @param data String which you want to write a file. If size of this is greater than size available, it will show error.
     */
